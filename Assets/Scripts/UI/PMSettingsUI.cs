...
public class PMSettingsUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        contPlacement.isOn = PlacementManager.Instance.continuousPlacement;

        showGrid.isOn = PlacementManager.Instance.showGrids;
    }
    ...
    private void Update()
    {
        ...
        PlacementManager.Instance.continuousPlacement = contPlacement.isOn;

        PlacementManager.Instance.showGrids = showGrid.isOn;
